            ...
            <div className="max-w-7xl mx-auto grid xl:grid-cols-2 md:grid-cols-1 gap-5">
                ...
                <div className="flex xl:block flex-col items-center w-full">
                    ...
                    <Image
                        ...
                        width={550}
                        height={400}
                        className="xl:w-150 xl:h-130 rounde"
                ...
                <div className="relative  xl:w-[600px]">
                    {array.map((item, index) => (
                        <div
                            ...
                            className={`absolute top-10 left-0 w-full p-6 rounded-xl shadow-md xl:w-[600px] `}
                            style={{
                        ...
                        >
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="xl:text-2xl text-sm font-[500] mb-2">
                                        {item.tiltle}
                                    </h3>
